...
def pretrain(args):
    ...
    module, vocab_enc2atom, *_ = build_qm9_dataloader(
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        save_top_k=5,
        monitor='denoise_loss_t10',
        mode='min',
        filename='{epoch}-{step}-{connected_ratio:.2f}'
    )

    EMA = StochasticWeightAveraging(1e-3, avg_fn=ema_avg_fn)

    # EarlyStopping monitors denoise_loss_t100 which is logged in
